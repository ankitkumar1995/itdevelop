...
import { incubationFacilitiySchema } from '../schema/FormSchema';
import { Col, Row } from 'reactstrap';
import { Plus } from 'react-feather';

const EditFacilitiesForm = ({ initialValues, onFormSubmit }) => {
  const fieldName = 'facilities';
  const handleSubmit = (values) => {
    const data = {
      facilities: values[fieldName],
    };
    onFormSubmit({ ...data });
  };
  return (
    <div className="profile-form-container">
      <Formik
        ...
        validationSchema={incubationFacilitiySchema}
      >
