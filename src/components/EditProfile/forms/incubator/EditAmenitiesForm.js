...
import { incubatorAmenitiesSchema } from '../schema/FormSchema';
import { Col, Row } from 'reactstrap';
import { Plus } from 'react-feather';

const EditAmenitiesForm = ({ initialValues, onFormSubmit }) => {
  const fieldName = 'amenities';
  const handleSubmit = (values) => {
    const data = {
      'registeration.amenitiesOrEvents.amenities': values[fieldName],
    };
    onFormSubmit({ ...data });
  };
  return (
    <div className="profile-form-container">
      <Formik
        ...
        validationSchema={incubatorAmenitiesSchema}
      >
