...
import { investorPitchsSchema } from '../schema/FormSchema';
import { Col, Row } from 'reactstrap';
import { Plus } from 'react-feather';

const EditPitchsForm = ({ initialValues, onFormSubmit }) => {
  const fieldName = 'pitchs';
  const handleSubmit = (values) => {
    const data = {
      howToPitch: values[fieldName],
    };
    onFormSubmit({ ...data });
  };
  return (
    <div className="profile-form-container">
      <Formik
        ...
        validationSchema={investorPitchsSchema}
      >
