...
import { investorReachsSchema } from '../schema/FormSchema';
import { Col, Row } from 'reactstrap';
import { Plus } from 'react-feather';

const EditReachsForm = ({ initialValues, onFormSubmit }) => {
  const fieldName = 'reachs';
  const handleSubmit = (values) => {
    const data = {
      whomToReach: values[fieldName],
    };
    onFormSubmit({ ...data });
  };
  return (
    <div className="profile-form-container">
      <Formik
        ...
        validationSchema={investorReachsSchema}
      >
