...
import { investorPortfoliosSchema } from '../schema/FormSchema';
import { Col, Row } from 'reactstrap';
import { Plus } from 'react-feather';

const EditPortfolioForm = ({ initialValues, onFormSubmit }) => {
  const fieldName = 'portfolios';
  const handleSubmit = (values) => {
    const data = {
      portfolioCompanies: values[fieldName],
    };
    onFormSubmit({ ...data });
  };
  return (
    <div className="profile-form-container">
      <Formik
        ...
        validationSchema={investorPortfoliosSchema}
      >
