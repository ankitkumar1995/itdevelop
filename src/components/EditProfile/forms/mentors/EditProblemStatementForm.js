...
import { mentorProblemSchema } from '../schema/FormSchema';
import { Col, Row } from 'reactstrap';
import { Plus } from 'react-feather';

const EditProblemStatementForm = ({ initialValues, onFormSubmit }) => {
  const fieldName = 'problems';
  const handleSubmit = (values) => {
    const data = {
      topMentorsGuidance: values[fieldName],
    };
    onFormSubmit({ ...data });
  };
  return (
    <div className="profile-form-container">
      <Formik
        ...
        validationSchema={mentorProblemSchema}
      >
...
export default EditProblemStatementForm;
