...
import { marketNeedsSchema } from '../schema/FormSchema';
import { Col, Row } from 'reactstrap';
import { Plus } from 'react-feather';

const EditMarketNeedsForm = ({ initialValues, onFormSubmit }) => {
  const fieldName = 'needs';
  const handleSubmit = (values) => {
    const data = {
      marketNeeds: values[fieldName],
    };
    onFormSubmit({ ...data });
  };
  return (
    <div className="profile-form-container">
      <Formik
        ...
        validationSchema={marketNeedsSchema}
      >
...
export default EditMarketNeedsForm;
