...
import { partnerOfferingsSchema } from '../schema/FormSchema';
import { Col, Row } from 'reactstrap';
import { Plus } from 'react-feather';

const EditOfferingsForm = ({ initialValues, onFormSubmit }) => {
  const fieldName = 'offers';
  const handleSubmit = (values) => {
    const data = {
      'registration.partnerInfo.serviceOffers': values[fieldName],
    };
    onFormSubmit({ ...data });
  };
  return (
    <div className="profile-form-container">
      <Formik
        ...
        validationSchema={partnerOfferingsSchema}
      >
...
export default EditOfferingsForm;
