    ...
    >
      <FormikStep
        ...
        validationSchema={yup.object({
          fullName: yup
            .string()
            .matches(characterRegex, 'Partner name can contains only alphabets')
            .min(2, 'Name atleast 2 characters')
            .max(100, 'Name not be more than 100 characters')
            .required('Please enter partner name'),
          partnerType: yup.string().required('Please select partner type'),
          otherPartnerType: yup.string().when('partnerType', {
            is: 'Others',
            then: yup
              .string()
              .max(50, 'Max 50 characters are allowed')
              .required('Please enter other partner type'),
          }),
